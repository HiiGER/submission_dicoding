class DataAnalyzer:
    ...
    def create_daily_orders_df(self):
        ...
        daily_orders_df.rename(
            columns={"order_id": "order_count", "payment_value": "revenue"},
            inplace=True,
        )
    ...
    def create_sum_order_items_df(self):
        sum_order_items_df = (
            self.df.groupby("product_category_name_english")["product_id"]
            .count()
            .reset_index()
        )
    ...
    def create_bystate_df(self):
        ...
        most_common_state = bystate_df.loc[
            bystate_df["customer_count"].idxmax(), "customer_state"
        ]
